...
public class JdbcSinkConfig extends AbstractConfig {
    ...
    public static final String DEBUG_SKIP_DATE_CONVERSION = "debug.skip.date.conversion";
    private static  final boolean DEBUG_SKIP_DATE_CONVERSION_DEFAULT = false;
    private static final String DEBUG_SKIP_DATE_CONVERSION_DOC = "skip date conversion for debug purpose";
...
//=====================
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(DEBUG_SKIP_DATE_CONVERSION,ConfigDef.Type.BOOLEAN, DEBUG_SKIP_DATE_CONVERSION_DEFAULT, ConfigDef.Importance.MEDIUM, DEBUG_SKIP_DATE_CONVERSION_DOC);
    ...
    public final boolean debugSkipDateConversion;
    ...
    public JdbcSinkConfig(Map<?, ?> props) {
        ...
        debugSkipDateConversion = getBoolean(DEBUG_SKIP_DATE_CONVERSION);
